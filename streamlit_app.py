...
beds = st.number_input("Number of Bedrooms", value = "")
baths = st.number_input("Number of Bathrooms", value = "")
sqft = st.number_input("House Size (sqft)", value = "")
acre_lot = st.number_input("Lot Size (acre)", value = "")
